...
export const CANONICAL_FAQS: FaqItemData[] = [
  ...
  },
  {
    ...
    aEn: "Every member is a Godmother from the day she joins — there is nothing to apply for. Your personal referral code is already in your account. A mother adds it to her application, and once she joins you earn 5 credits, plus 15 more when she reaches three months. Bonus credits are ordinary credits: no ceiling, and the same six-month expiry as the rest.",
    qEs: "¿Cómo funciona el referido de Madrina?",
    aEs: "Cada socia es Madrina desde el día en que se une: no hay nada que solicitar. Tu código de referido personal ya está en tu cuenta. Una madre lo añade en su solicitud y, cuando se une, ganas 5 créditos, más 15 cuando ella cumple tres meses. Los créditos extra son créditos normales: no hay ningún límite de acumulación y caducan a los 6 meses, como el resto.",
  },
  {
    group: "Guests & the Event Pass",
    qEn: "Can I come to an event without being a member?",
    aEn: "Yes. An Event Pass is €35 and books you one place at any event worth up to 18 credits. Each event holds a small number of guest places — usually two. Most of the calendar sits under that; the event card tells you whether a pass can book it. Everyone gets two passes in total — enough to know whether this is your room — and after that it's membership. Only Signature moments, and anything above 18 credits, stay with members. If you join within thirty days of the event, we waive the joining fee — so your first payment is just €39, the month itself. Join later than thirty days and the €19 joining fee applies as usual, unless you are one of our first 50 members, who pay no joining fee either way. Your receipt is your ticket — it carries the meeting point and a link to release your place if your plans change. The €35 is not refunded, but the seat goes to another mother. Walks and park socials are always free, no booking fee at all.",
    qEs: "¿Puedo asistir a un evento sin ser socia?",
    aEs: "Sí. Un Event Pass cuesta 35€ y te reserva una plaza en cualquier evento de hasta 18 créditos. Cada evento guarda un número reducido de plazas de invitada — normalmente dos. La mayor parte del calendario está por debajo; la tarjeta del evento indica si un pase puede reservarlo. Cada persona tiene dos pases en total, y después toca la membresía. Solo los Signature moments, y lo que supere los 18 créditos, quedan para socias. Si te unes dentro de los treinta días siguientes al evento, te quitamos la cuota de inscripción: tu primer pago son 39€, solo el mes. Si te unes más tarde, se aplica la cuota de 19€ con normalidad — salvo que seas una de nuestras primeras 50 socias, que no pagan cuota de inscripción en ningún caso. Tu recibo es tu entrada: lleva el punto de encuentro y un enlace para liberar tu plaza si te cambian los planes. Los 35€ no se devuelven, pero la plaza pasa a otra madre. Los paseos y encuentros en el parque son siempre gratuitos.",
  },
  {
    group: "Membership & money",
    qEn: "Can I pay every three months instead?",
    aEn: "Yes, and it costs a little less. Membership is €39 a month or €99 every three months — one rate, two rhythms. You choose when you apply, and you can switch at your next renewal. Your credits arrive the same way either way — 20 at the start of each month, not 60 in one go, so the calendar stays reachable all quarter rather than filling up in week one.",
    qEs: "¿Puedo pagar cada tres meses?",
    aEs: "Sí, y sale algo más económico. La membresía son 39€ al mes o 99€ cada tres meses — una tarifa, dos ritmos. Lo eliges al solicitar tu plaza y puedes cambiarlo en tu siguiente renovación. Tus créditos llegan igual en ambos casos: 20 al inicio de cada mes, no 60 de golpe, para que el calendario siga a tu alcance todo el trimestre en lugar de llenarse la primera semana.",
  },
  {
    group: "Membership & money",
    qEn: "Can I pause or cancel my membership?",
    aEn: "Yes. Pause for up to two months a year at no cost, and cancel anytime — there is never a cancellation fee. Your credit expiry clock pauses too, so you never lose credits while stepped away. One difference worth knowing: a pause keeps everything as it is, while cancelling ends the membership — and if you rejoin later, the €19 joining fee applies again.",
    qEs: "¿Puedo pausar o cancelar mi membresía?",
    aEs: "Sí. Puedes pausarla hasta dos meses al año sin coste, y cancelar en cualquier momento — nunca hay cuota de cancelación. El reloj de caducidad de tus créditos también se pausa, así que nunca pierdes créditos mientras estás fuera. Una diferencia que conviene saber: pausar lo deja todo como está, mientras que cancelar termina la membresía — y si vuelves más adelante, la cuota de inscripción de 19€ se aplica de nuevo.",
  },
  {
    group: "Events",
  ...
  },
  {
    ...
    aEn: "€39 a month, or €99 every three months — one membership, everything included. On top of that there is a one-time €19 joining fee with your first payment, and two ways it disappears: our first 50 members pay no joining fee at all, and it is waived for anyone who has taken an Event Pass in the 30 days before joining. Nothing else is charged — no booking fees, no cancellation fees.",
    qEs: "¿Cuánto cuesta unirse exactamente?",
    aEs: "39€ al mes, o 99€ cada tres meses — una sola membresía, todo incluido. Además hay una cuota única de inscripción de 19€ con el primer pago, y dos formas de que desaparezca: nuestras primeras 50 socias no la pagan, y tampoco quien haya tomado un Event Pass en los 30 días anteriores. No se cobra nada más — ni por reservar, ni por cancelar.",
  },
  {
    group: "Joining",
