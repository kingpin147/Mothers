...
const RAW_SECTIONS: [string, string, string, [string, string, string, string][]][] = [
  ...
  [
    ...
    [
      ...
      ["", "2.16", "Open an event that is not yet confirmed.", "The word GATHERING facing the public, with its minimum — never filling."],
  ...
  [
    ...
    [
      ...
      ["", "9.15", "GATHERING is the word facing the public; filling is internal only.", "The public word never appears in the admin sense, and the internal word never reaches a member."],
