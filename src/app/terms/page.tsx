...
export default function LegalPage() {
  ...
  const termsSections = isEn
    ? [
        ...
        { n: "01", title: "Membership & the Membership Window", body: "Membership is by application. A Membership Window opens once a month and stays open for one week; in each Window we open a limited number of spots — the one-time €48 joining fee is waived for our first 50 founding members. Outside a Window, applications join a waitlist and are reviewed at the next opening. Submitting an application does not guarantee acceptance; we review each application individually to keep the community safe and considered." },
        { n: "02", title: "Fees & billing", body: "Membership is €39/month or €99 every 3 months (collected by card). There is a one-time joining fee of €48, which is waived for our first 50 founding members. You choose your billing frequency when you apply. You may cancel at any time with no cancellation fee — your membership ends at the close of the current billing period. You may pause your membership for up to two months per calendar year at no cost; your credit expiry clock pauses along with it." },
    ...
    : [
        ...
        { n: "01", title: "Membresía y la Ventana de membresía", body: "La membresía es por solicitud. Cada mes se abre una Ventana de membresía y permanece abierta una semana; en cada Ventana abrimos un número limitado de plazas — la cuota única de inscripción de 48€ es gratuita para nuestras primeras 50 socias fundadoras. Fuera de una Ventana, las solicitudes entran en lista de espera y se revisan en la siguiente apertura. El envío de una solicitud no garantiza la aceptación; revisamos cada una de forma individual para mantener la comunidad segura e intencional." },
        { n: "02", title: "Tarifas y facturación", body: "La membresía es de 39€/mes o 99€ cada 3 meses (cobro con tarjeta). Hay una cuota de inscripción única de 48€, gratuita para nuestras primeras 50 socias fundadoras. Eliges la periodicidad de pago al solicitar tu plaza. Puedes cancelar en cualquier momento sin penalización — tu membresía concluye al finalizar el periodo facturado. Puedes pausar tu membresía hasta dos meses por año natural sin coste; el reloj de caducidad de tus créditos se pausa igualmente." },
        ...
        { n: "04", title: "Event Pass", body: "Si no eres socia, puedes asistir a eventos de hasta 18 créditos (salvo Signature moments) con un Event Pass de 35€ — los paseos y encuentros en el parque son siempre gratuitos. Cada persona puede comprar un máximo de dos Event Pass en total. Las plazas de invitada abren catorce días antes y cierran dos días antes del evento. Si te unes a The Mothers en los 30 días posteriores, tus 35€ se descuentan de tu cuota de inscripción (13€ en lugar de 48€)." },
