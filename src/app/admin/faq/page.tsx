  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#f8efe2" }}>
      <div style={{ borderBottom: "1px solid rgba(57,41,42,0.16)" }}>
        <div style={{ maxWidth: "860px", margin: "0 auto", padding: "14px clamp(18px, 3vw, 30px)", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "20px", flexWrap: "wrap" }}>
