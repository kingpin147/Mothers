        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 350px), 1fr))", gap: "24px 32px" }}>
          ...
          <div>
            <div style={{ fontSize: "13.5px", lineHeight: 1.6, color: "rgba(57,41,42,0.7)", textWrap: "pretty" }}>
              <strong style={{ fontWeight: 600, color: "#39292a" }}>The public calendar</strong> — <Link href="/events" style={{ color: "#7b1f2c" }}>Events</Link> shows it under its category, in its month, with its credit cost and the to be confirmed line if it has a minimum.
            </div>
          </div>
