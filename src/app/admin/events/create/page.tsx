    ...
    <div style={{ minHeight: "100vh", background: "rgba(57,41,42,0.34)", padding: "clamp(18px,4vw,46px) clamp(14px,3vw,30px)", fontFamily: "'Lora', Georgia, serif", color: "#39292a", WebkitFontSmoothing: "antialiased" }}>
      ...
      <div style={{ maxWidth: "880px", margin: "0 auto", background: "#fffdfa", border: "1px solid rgba(57,41,42,0.2)", borderRadius: "10px", boxShadow: "0 18px 50px rgba(57,41,42,0.18)", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: "880px", margin: "20px auto 0", border: "1px solid rgba(255,253,250,0.35)", borderRadius: "8px", background: "rgba(255,253,250,0.92)", padding: "18px 22px" }}>
          <div style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 600, fontSize: "11px", letterSpacing: "0.14em", textTransform: "uppercase", color: "rgba(57,41,42,0.5)", marginBottom: "10px" }}>What changed from the current modal</div>
